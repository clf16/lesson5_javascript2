function calculateTax(){
        ...
        ***********************************************************************************************/
        ...
        if (income <= 19050){
                 ...
                 tax = 19050 * 0.10 + (77400 - 19050) * 0.12 + (income - 38700) * 0.22;
                 taxRate = 22;
               } //end of else if
               else if (income <= 315000) {
                 tax = 19050 * 0.10 + (77400 - 19050) * 0.12 +
                       (165000 - 38700) * 0.22 + (income - 82500) * 0.24;
                 taxRate = 24;
               }//end of else if
               else if (income <= 400000) {
                 tax = 19050 * 0.10 + (77400 - 19050) * 0.12 +
                       (165000 - 38700) * 0.22 + (315000 - 82500) * 0.24 +
                       (income - 157500) * 0.32;
                 taxRate = 32;
               }//end of else if
                  ...
                  tax = 19050 * 0.10 + (77400 - 19050) * 0.12 +
                        (165000 - 38700) * 0.22 + (315000 - 82500) * 0.24 +
                        (400000 - 157500) * 0.32 + (income - 200000) * 0.35;
                  taxRate = 35;
               }//end of else if
               else {
                  tax = 19050 * 0.10 + (77400 - 19050) * 0.12 +
                        (165000 - 38700) * 0.22 + (315000 - 82500) * 0.24 +
                        (400000 - 157500) * 0.32 + (600000 - 200000 ) * 0.35 + (income - 500000) * .37;
                  taxRate = 37;
               }
          ...
          *******************************************************************************/
            ...
            if (income <= 9525){
                 ...
                 taxRate = 32;
                  ...
                  tax = 9525 * 0.10 + (38700 - 9525) * 0.12 +
                        (82500 - 38700) * 0.22 + (157500 - 82500) * 0.24 +
                        (200000 - 157500) * 0.32 + (300000 - 200000 ) * 0.35 + (income - 500000) * .37;
                  taxRate = 37;
               }
...
function clearButton () {
             ...
             document.getElementById("taxBracket_Calculator").reset();
